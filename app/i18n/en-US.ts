...
export default {
  ...
  'Poll.title': 'Question to the attendees?',
  ...
  'Poll.noActivePoll': `There is no active poll`,
  'Poll.inputPlaceHolder': `Type something`,
  'Poll.inputEmpty': 'N/A',
  'Poll.unableSubmitVote': 'Unable to submit your vote, please try again later',
  'Poll.successfullySubmitVote': 'Your vote has been send.',
  'Poll.unableSubmitPoll':
    'An error occurred while sharing your poll, please try again later.',
  'Poll.successfullySubmitPoll': 'You have successfully shared the poll.',
